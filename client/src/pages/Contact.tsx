...
export default function Contact() {
  ...
  useSEO({
    title: "تواصل معنا",
    description: "تواصل مع جمعية طويق للخدمات الإنسانية — الرياض، العريجاء الوسطى — هاتف 0505793012",
  });
              ...
              <Card>
                ...
                <CardContent>
                  <div className="flex gap-4">
                    <a href="https://x.com/tuwaiq_2o3o" target="_blank" rel="noopener noreferrer" className="w-12 h-12 bg-black text-white rounded-xl flex items-center justify-center hover:opacity-80 transition-opacity" data-testid="social-twitter">
                      <SiX className="w-6 h-6" />
                    </a>
                    <a href="https://instagram.com/tuwaiq_2o3o" target="_blank" rel="noopener noreferrer" className="w-12 h-12 bg-gradient-to-br from-purple-600 to-pink-500 text-white rounded-xl flex items-center justify-center hover:opacity-80 transition-opacity" data-testid="social-instagram">
                      <SiInstagram className="w-6 h-6" />
                    </a>
                    <a href="https://facebook.com/tuwaiq_2o3o" target="_blank" rel="noopener noreferrer" className="w-12 h-12 bg-blue-600 text-white rounded-xl flex items-center justify-center hover:opacity-80 transition-opacity" data-testid="social-facebook">
                      <SiFacebook className="w-6 h-6" />
                    </a>
                    <a href="https://youtube.com/@tuwaiq_2o3o" target="_blank" rel="noopener noreferrer" className="w-12 h-12 bg-red-600 text-white rounded-xl flex items-center justify-center hover:opacity-80 transition-opacity" data-testid="social-youtube">
